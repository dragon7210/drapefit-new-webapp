...
import AuthInventoryForgotPwd from '../auth-forms/AuthInventoryForgotPwd';

const Logo = GenS3Link('landing/images/logo_full');

const InventoryForgotPwd = () => {
...
export default InventoryForgotPwd;
