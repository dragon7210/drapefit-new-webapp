...
import { loginSupplier } from 'actions/common/auth';

const AuthSupplierLogin = ({ ...rest }) => {
    ...
    <>
      <Formik
        ...
        onSubmit={async (values) => {
          dispatch(loginSupplier(values, remChecked, navigate));
        }}
      >
...
export default AuthSupplierLogin;
