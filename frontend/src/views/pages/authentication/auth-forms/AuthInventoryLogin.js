...
import { loginInventory } from 'actions/common/auth';

const AuthInventoryLogin = ({ ...rest }) => {
    ...
    <>
      <Formik
        ...
        onSubmit={async (values) => {
          dispatch(loginInventory(values, remChecked, navigate));
        }}
      >
          ...
          <Form noValidate onSubmit={handleSubmit} {...rest}>
            ...
            <Stack direction="row" alignItems="center" justifyContent="space-between" spacing={1}>
              <FormControlLabel
                ...
                label="Remember me"
              />
              <Link to="/dfinventory/forgot-pwd">
...
export default AuthInventoryLogin;
