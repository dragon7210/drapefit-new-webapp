...
import { getMonthlyRevenue } from 'actions/admin/report';
...
const MonthlyRevenue = () => {
  ...
  const { monthlyRevenueList } = useSelector((state) => state.report);
  let updateData = monthlyRevenueList.map((item) => {
    return {
      ...item,
  ...
  return (
    <>
      <Box className="admin-page-title-part">
        <Typography className="page-title">Revenue</Typography>
