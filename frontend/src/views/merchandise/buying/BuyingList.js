...
import { faDashboard, faTrashCan, faEdit } from '@fortawesome/free-solid-svg-icons';
...
const columns = [
  ...
  { accessorKey: 'clearancePrice', header: 'Clearance Price', enableColumnFilter: false },
      ...
      <Grid container className="admin-page-title-part">
        <Grid item xs={12} className="h-align-right">
          <Breadcrumbs>
            ...
            <Typography className="home-link disable">Buying</Typography>
            <Typography className="home-link current">Buying List</Typography>
          </Breadcrumbs>
        </Grid>
        <Grid item xs={12} className="h-align-left">
          <Typography className="page-title">Buying List</Typography>
        </Grid>
      </Grid>
