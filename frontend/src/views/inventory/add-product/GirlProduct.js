...
import { bodyShapeList, typeOfPrintList, availableStatusList, selectProps, profileList } from 'constant/other';
...
import { iHeightFt, iHeightIn, iWaistSizeLabel } from 'constant/basic';
import { iShoeSize, iTopSize } from 'constant/kidStyleFit';

const GirlProduct = ({ data }) => {
    ...
    <>
      <Grid container className="admin-page-title-part">
        ...
        <Grid item xs={12} className="h-align-left">
          <Typography className="page-title">{isEdit ? `Edit` : `Add`} Product For Girl Kids</Typography>
        </Grid>
      </Grid>
