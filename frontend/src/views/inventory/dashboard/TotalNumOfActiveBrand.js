...
const TotalNumOfActiveBrand = ({ isLoading, count }) => {
            ...
            <List sx={{ py: 0 }}>
              <ListItem alignItems="center" disableGutters sx={{ py: 1 }}>
                ...
                <ListItemText
                  ...
                  secondary={
                    <Typography sx={{ color: '#fff', fontSize: '16px', mt: 0.25 }}>Number of Acitve Brand</Typography>
                  }
                />
              </ListItem>
            </List>
...
TotalNumOfActiveBrand.propTypes = {
  isLoading: PropTypes.bool,
  count: PropTypes.number
};

export default TotalNumOfActiveBrand;
